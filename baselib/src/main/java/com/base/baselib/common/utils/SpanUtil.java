...
public final class SpanUtil {
     ...
     * @return {@link SpanUtil}
     */
    public SpanUtil setQuoteColor(@ColorInt final int color, @IntRange(from = 1) final int stripeWidth, @IntRange(from = 0) final int gapWidth) {
     ...
     * @return {@link SpanUtil}
     */
    public SpanUtil setLeadingMargin(@IntRange(from = 0) final int first, @IntRange(from = 0) final int rest) {
        this.first = first;
        this.rest = rest;
        return this;
    }
     ...
     * @return {@link SpanUtil}
     */
    public SpanUtil setBullet(@ColorInt final int color, @IntRange(from = 0) final int radius, @IntRange(from = 0) final int gapWidth) {
     ...
     * @return {@link SpanUtil}
     */
    public SpanUtil setIconMargin(final Bitmap bitmap) {
     ...
     * @return {@link SpanUtil}
     */
    public SpanUtil setIconMargin(final Bitmap bitmap, final int gapWidth, @Align final int align) {
     ...
     * @return {@link SpanUtil}
     */
    public SpanUtil setIconMargin(final Drawable drawable) {
     ...
     * @return {@link SpanUtil}
     */
    public SpanUtil setIconMargin(final Drawable drawable, final int gapWidth, @Align final int align) {
     ...
     * @return {@link SpanUtil}
     */
    public SpanUtil setIconMargin(final Uri uri) {
     ...
     * @return {@link SpanUtil}
     */
    public SpanUtil setIconMargin(final Uri uri, final int gapWidth, @Align final int align) {
     ...
     * @return {@link SpanUtil}
     */
    public SpanUtil setIconMargin(@DrawableRes final int resourceId) {
     ...
     * @return {@link SpanUtil}
     */
    public SpanUtil setIconMargin(@DrawableRes final int resourceId, final int gapWidth, @Align final int align) {
     ...
     * @return {@link SpanUtil}
     */
    public SpanUtil setFontSize(@IntRange(from = 0) final int size, final boolean isDp) {
        this.fontSize = size;
     ...
     * @return {@link SpanUtil}
     */
    public SpanUtil setFontProportion(@FloatRange(from = 0, fromInclusive = false) final float proportion) {
     ...
     * @return {@link SpanUtil}
     */
    public SpanUtil setFontXProportion(@FloatRange(from = 0, fromInclusive = false) final float proportion) {
     ...
     * @return {@link SpanUtil}
     */
    public SpanUtil setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius, final Blur style) {
