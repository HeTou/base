...
public class RegexUtil {
     ...
     * @return
     */
    public static boolean matchs(String regex, String content) {
     ...
     * @return
     */
    public static String replaces(String regex, String content, String newStr) {
        if (regex == null) return content;
        return content.replaceAll(regex, newStr);
    }
    ...
    public static String cardIdHide(String cardId) {
        if (cardId != null) {
//            if (cardId.length() == 16) {
            return cardId.replaceAll("\\d+([\\dXx]{4})", "**** **** **** $1");
//            } else {
//                return cardId.replaceAll("\\d+(\\d{1})([\\dXx]{3})", "**** **** ***$1 $2");
//            }
        } else {
            return cardId;
        }
