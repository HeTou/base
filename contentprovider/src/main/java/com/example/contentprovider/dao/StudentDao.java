...
public class StudentDao extends AbstractDao<Student, Long> {
    ...
    public static class Properties {
        ...
        public final static Property IsJob = new Property(4, boolean.class, "isJob", false, "IS_JOB");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"STUDENT\" (" + //
                ...
                "\"IS_JOB\" INTEGER NOT NULL );"); // 4: isJob
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Student entity) {
        ...
        stmt.bindLong(5, entity.getIsJob() ? 1L: 0L);
    }
    ...
    public Student readEntity(Cursor cursor, int offset) {
        Student entity = new Student( //
            ...
            cursor.getShort(offset + 4) != 0 // isJob
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Student entity, int offset) {
        ...
        entity.setIsJob(cursor.getShort(offset + 4) != 0);
     }
